package com.pomodoro.nostr.ui.screens.auth
                ...
                Button(
                    onClick = {
                        if (uiState.isAmberAvailable) {
                            ...
                            viewModel.setError("Amber signer app is not installed. Install it from F-Droid or zapstore.")
                        }
                    },
